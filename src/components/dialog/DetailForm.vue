<template>
  <el-dialog title="案例详情" :visible.sync="visible" width="80%">
    <div class="dialog">
      <el-tabs>
        ...
        <el-tab-pane label="环境信息">
          <el-form label-width="180px" label-position="right" :model="envInfo" disabled>
            <!-- 第一行 -->
            <el-row>
              <el-col :span="8">
        ...
        <el-tab-pane label="道路信息" class="tab-scroll">
          <el-scrollbar style="height:90%;">
            <el-form label-width="250px" label-position="right" :model="wayInfo" ref="wayInfoRef">
              <el-row>
                <el-col :span="8">
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item label="参与方所在道路名称" prop="r6003">
                    <el-input v-model="wayInfo.r6003" disabled></el-input>
                  </el-form-item>
                </el-col>

                <el-col :span="8">
                  <el-form-item label="总体机动车道数（条）" prop="r6004">
                    <el-input v-model="wayInfo.r6004" disabled></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <!-- 第二行 -->
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item label="非机动车道" prop="r6007">
                    <el-select v-model="wayInfo.r6007" placeholder="请选择" disabled>
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label="对向机动车道隔离形式" prop="r6009">
                    <el-select v-model="wayInfo.r6009" placeholder="请选择" disabled>
                ...
                <el-col :span="8">
                  <el-form-item label="本侧机非车道隔离形式" prop="r6010">
                    <el-select v-model="wayInfo.r6010" placeholder="请选择" disabled>
                ...
                <el-col :span="8">
                  <el-form-item label="对向机动车道侧机非车道隔离形式" prop="r6011">
                    <el-select v-model="wayInfo.r6011" placeholder="请选择" disabled>
                      <el-option v-for="item in dataProcess.isolationForm2" :key="item.value" :label="item.label" :value="item.value">
                      </el-option>
                    </el-select>
                  </el-form-item>
                ...
                <el-col :span="8">
                  <el-form-item label="道路总宽度(m)" prop="r6012">
                    <el-input v-model="wayInfo.r6012" disabled></el-input>
                  </el-form-item>
                </el-col>

                <el-col :span="8">
                  <el-form-item label="所在车道的宽度(m)" prop="r6013">
                    <el-input v-model="wayInfo.r6013" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="道路横截面的轮廓" prop="r6008">
                    <el-select v-model="wayInfo.r6008" placeholder="请选择" disabled>
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label="最高允许车速(km/h)" prop="r6014">
                    <el-input v-model="wayInfo.r6014" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="现场有何种交通警告标志" prop="r6015">
                    <el-select v-model="wayInfo.r6015" placeholder="请选择" disabled>
                ...
                <el-col :span="8">
                  <el-form-item label="现场有何种交通禁令标志" prop="r6016">
                    <el-select v-model="wayInfo.r6016" placeholder="请选择" disabled>
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item label="沿道路方向的趋势" prop="r6018">
                    <el-select v-model="wayInfo.r6018" placeholder="请选择" disabled>
                      <el-option v-for="item in dataProcess.roadTrend" :key="item.value" :label="item.label" :value="item.value">
                      </el-option>
                    </el-select>
                  </el-form-item>
                ...
                <el-col :span="8">
                  <el-form-item label="路面材料" prop="r6019">
                    <el-select v-model="wayInfo.r6019" placeholder="请选择" disabled>
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label="道路表面污染" prop="r6020">
                    <el-select v-model="wayInfo.r6020" placeholder="请选择" disabled>
                ...
                <el-col :span="8">
                  <el-form-item label="路表潮湿度" prop="r6021">
                    <el-select v-model="wayInfo.r6021" placeholder="请选择" disabled>
                ...
                <el-col :span="8">
                  <el-form-item label="路面状况" prop="r6022">
                    <el-select v-model="wayInfo.r6022" placeholder="请选择" disabled>
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label="交通标志是否被阻挡不可见" prop="r6023">
                    <el-select v-model="wayInfo.r6023" placeholder="请选择" disabled>
                ...
                <el-col :span="8">
                  <el-form-item label="路口信号灯" prop="r6024">
                    <el-select v-model="wayInfo.r6024" placeholder="请选择" disabled>
                ...
                <el-col :span="8">
                  <el-form-item label="路灯是否开启" prop="r6025">
                    <el-select v-model="wayInfo.r6025" placeholder="请选择" disabled>
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label="路灯的密度" prop="r6026">
                    <el-select v-model="wayInfo.r6026" placeholder="请选择" disabled>
                ...
                <el-col :span="8">
                  <el-form-item label="是否有轨道" prop="r6027">
                    <el-select v-model="wayInfo.r6027" placeholder="请选择" disabled>
                ...
                <el-col :span="8">
                  <el-form-item label="影响视线的障碍物" prop="r6028">
                    <el-select v-model="wayInfo.r6028" placeholder="请选择" disabled>
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label="道路状况评估" prop="r6029">
                    <el-select v-model="wayInfo.r6029" placeholder="请选择" disabled>
                ...
                <el-col :span="8">
                  <el-form-item label="是否有建筑设施" prop="r6030">
                    <el-select v-model="wayInfo.r6030" placeholder="请选择" disabled>
                ...
                <el-col :span="8">
                  <el-form-item label="交通限速设施" prop="r6031">
                    <el-select v-model="wayInfo.r6031" placeholder="请选择" disabled>
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label="车辆是否冲到相应路边" prop="r6032">
                    <el-select v-model="wayInfo.r6032" placeholder="请选择" disabled>
                ...
                <el-col :span="8">
                  <el-form-item label="是否为变宽路段" prop="r6033">
                    <el-select v-model="wayInfo.r6033" placeholder="请选择" disabled>
                ...
                <el-col :span="8">
                  <el-form-item label="是否有为变窄路段" prop="r6034">
                    <el-select v-model="wayInfo.r6034" placeholder="请选择" disabled>
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label="是否有隧道" prop="r6035">
                    <el-select v-model="wayInfo.r6035" placeholder="请选择" disabled>
                ...
                <el-col :span="8">
                  <el-form-item label="是否为匝道口" prop="r6036">
                    <el-select v-model="wayInfo.r6036" placeholder="请选择" disabled>
                      <el-option v-for="item in dataProcess.tunnel" :key="item.value" :label="item.label" :value="item.value">
                      </el-option>
                    </el-select>
                  </el-form-item>
        ...
        <el-tab-pane label="参与方信息" class="tab-scroll">
          ...
          <el-scrollbar style="height:90%;">
            <!-- 车 -->
            <el-form label-width="250px" disabled label-position="right" :model="partInfoCar" class="tab-scroll" v-show="partTypeVal === '车' ? true : false">
              <!-- 第一行 -->
              <el-row>
                <el-col :span="8">
            ...
            <!-- 人 -->
            <el-form v-show="partTypeVal === '人' ? true : false" disabled label-width="250px" label-position="right" :model="partInfoPeo" class="tab-scroll">
              <!-- 第一行 -->
              <el-row>
                <el-col :span="8">
            ...
            <!--二/三轮车  -->
            <el-form label-width="250px" label-position="right" disabled :model="partInfoTH" ref="partInfoThRef" class="tab-scroll" v-show="partTypeVal === '二/三轮车' ? true : false">
              <!-- 第一行 -->
              <el-row>
                <el-col :span="8">
    ...
    <span slot="footer" class="dialog-footer">
      <el-button @click="dialogClose" type="info">关 闭</el-button>
    </span>
  </el-dialog>
</template>
